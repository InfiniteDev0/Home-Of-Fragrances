...
const WomenShoppage = () => {
  ...
  return (
    <div className="flex flex-col gap-5 !py-22 w-full !px-6 overflow-hidden">
      <div className="flex flex-col gap-2">
        <h1 className="font-semibold text-2xl">Women: Shop by Category</h1>
        <div className="flex items-center justify-between w-full">
          <ul className="flex gap-5 text-xs !pt-3 text-gray-600 font-semibold tracking-wider">
